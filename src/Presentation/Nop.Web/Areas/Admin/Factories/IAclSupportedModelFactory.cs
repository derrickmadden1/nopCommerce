...
/// <summary>
/// Model factory which supports access control list (ACL)
/// </summary>
public partial interface IAclSupportedModelFactory
{
    ...
    public Task PrepareModelCustomerRolesAsync<TModel>(TModel model) where TModel : IAclSupportedModel;
    ...
    /// <returns>A task that represents the asynchronous operation</returns>
    public Task PrepareModelCustomerRolesAsync<TModel>(TModel model, string entityName)
