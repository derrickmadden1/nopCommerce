...
public class PayPalCommercePaymentMethod : BasePlugin, IPaymentMethod, IWidgetPlugin
{
    ...
    public override async Task InstallAsync()
    {
        ...
        await AddOrUpdateResourcesAsync();
    ...
    protected async Task AddOrUpdateResourcesAsync()
    {
        await _localizationService.AddOrUpdateLocaleResourceAsync(new Dictionary<string, string>
        {
            ["Enums.Nop.Plugin.Payments.PayPalCommerce.Services.Api.Models.Enums.LandingPageType.LOGIN"] = "Login",
            ["Enums.Nop.Plugin.Payments.PayPalCommerce.Services.Api.Models.Enums.LandingPageType.GUEST_CHECKOUT"] = "Guest checkout",
            ["Enums.Nop.Plugin.Payments.PayPalCommerce.Services.Api.Models.Enums.LandingPageType.NO_PREFERENCE"] = "No preference",
            ...
            ["Plugins.Payments.PayPalCommerce.Fields.ImmediatePaymentRequired"] = "Immediate payment required",
            ["Plugins.Payments.PayPalCommerce.Fields.ImmediatePaymentRequired.Hint"] = "Determine whether the only immediate payment (credit card, PayPal balance, or instant ACH) from the customer is accepted. When enabled, this restricts the customer's ability to create a PayPal account or use pay-later from the guest checkout screen.",
            ["Plugins.Payments.PayPalCommerce.Fields.LandingPage"] = "Landing page",
            ["Plugins.Payments.PayPalCommerce.Fields.LandingPage.Hint"] = "Choose the type of landing page to show on the PayPal site for customer checkout.",
