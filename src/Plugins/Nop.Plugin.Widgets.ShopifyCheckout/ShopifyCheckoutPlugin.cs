...
public class ShopifyCheckoutPlugin : BasePlugin, IWidgetPlugin
{
    ...
    public override async Task InstallAsync()
    {
        ...
        await _localizationService.AddOrUpdateLocaleResourceAsync(new Dictionary<string, string>
        {
            ...
            ["Plugins.Widgets.ShopifyCheckout.Fields.ClientId"] = "Shopify App Client ID",
            ["Plugins.Widgets.ShopifyCheckout.Fields.ClientId.Hint"] = "Enter Client ID (API Key) for OAuth Client Credentials grant.",
            ["Plugins.Widgets.ShopifyCheckout.Fields.ClientSecret"] = "Shopify App Client Secret",
            ["Plugins.Widgets.ShopifyCheckout.Fields.ClientSecret.Hint"] = "Enter Client Secret (API Secret Key) for OAuth Client Credentials grant.",
