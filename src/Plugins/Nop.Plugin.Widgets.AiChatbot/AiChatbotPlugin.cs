...
public class AiChatbotPlugin : BasePlugin, IWidgetPlugin
{
    ...
    public override async Task InstallAsync()
    {
        ...
        await _localizationService.AddOrUpdateLocaleResourceAsync(new Dictionary<string, string>
        {
            ...
            ["Plugins.Widgets.AiChatbot.UseAzureKeyVault"] = "Use Azure Key Vault",
            ["Plugins.Widgets.AiChatbot.AzureKeyVaultUrl"] = "Key Vault URL",
            ["Plugins.Widgets.AiChatbot.AzureKeyVaultSecretName"] = "Key Vault Secret Name",
