...
namespace Nop.Plugin.Widgets.ShoppableBanner.Infrastructure;
...
public class ViewLocationExpander : IViewLocationExpander
{
    ...
    public IEnumerable<string> ExpandViewLocations(ViewLocationExpanderContext context, IEnumerable<string> viewLocations)
    {
        ...
        {
            viewLocations = new[] { $"/Plugins/Widgets.ShoppableBanner/Areas/Admin/Views/{context.ControllerName}/{context.ViewName}.cshtml" }.Concat(viewLocations);
        }
        else
        {
            viewLocations = new[] { $"/Plugins/Widgets.ShoppableBanner/Views/{context.ControllerName}/{context.ViewName}.cshtml" }.Concat(viewLocations);
        }
