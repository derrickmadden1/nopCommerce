...
public class ViewLocationExpander : IViewLocationExpander
{
    ...
    public IEnumerable<string> ExpandViewLocations(ViewLocationExpanderContext context, IEnumerable<string> viewLocations)
    {
        ...
        {
            viewLocations = new[] { $"/Plugins/Nop.Plugin.Widgets.ImagePuzzle/Areas/Admin/Views/{context.ControllerName}/{context.ViewName}.cshtml" }.Concat(viewLocations);
        }
        else
        {
            viewLocations = new[] { $"/Plugins/Nop.Plugin.Widgets.ImagePuzzle/Views/{context.ControllerName}/{context.ViewName}.cshtml" }.Concat(viewLocations);
        }
